...
export default function PatientSettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-5 sm:gap-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-[#1a2e0a] sm:text-[28px]">Settings</h1>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        <section className="rounded-xl border border-[#E8E4D8] bg-white p-4 sm:p-5 xl:col-span-2">
        ...
        <section className="rounded-xl border border-[#E8E4D8] bg-white p-4 sm:p-5">
          <div className="flex items-center gap-2 mb-5">
        ...
        <section className="rounded-xl border border-[#E8E4D8] bg-white p-4 sm:p-5 xl:col-span-3">
          ...
          <button className="mt-5 inline-flex min-h-10 w-full items-center justify-center gap-2 rounded-lg bg-[#1a2e0a] px-4 py-2 text-[13px] font-semibold text-white transition-colors hover:bg-[#2B4A18] sm:w-auto">
