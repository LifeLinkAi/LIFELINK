...
export default function DonorDashboard() {
  ...
  const handleWizardSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errMsg = error.response?.data?.message || "Failed to complete setup.";
      toast.error(errMsg);
    } finally {
    ...
    <main className="p-4 sm:p-6 lg:p-8 relative min-h-[calc(100vh-80px)]">
      ...
      {profile && !profile.isSetupComplete && (
        <div className="fixed inset-0 z-50 bg-[#0b120c]/60 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-8 max-w-lg w-full border border-neutral-100 shadow-2xl relative animate-scale-in">
            ...
            <p className="text-sm text-gray-500 mb-6 leading-relaxed">
              We require a few medical and contact details to list you as a life-saving donor in our matching coordination network.
            </p>
      ...
      {/* DASHBOARD CONTENT (Will appear blurred if setup is incomplete) */}
