    ...
    <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[13px] text-[#6B7A5A] mt-0.5">
              Manage transplant waitlist registrations and track patient status.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        ...
        <StatCard
          ...
          note="Requiring urgent attention"
          ...
          <div className="divide-y divide-[#F0EDE3]">
            {visible.map(patient => {
              ...
              return (
                <div
                  key={patient.id}
                  className="grid grid-cols-[minmax(0,2fr)_120px_100px_110px_130px_180px_48px] items-center px-5 py-4 hover:bg-[#FAFAF7] transition-colors group"
                >
                  {/* Patient */}
                  ...
                  {/* Urgency */}
                  <span className={cn(
                    'inline-flex items-center gap-1.5 text-[12px] font-semibold px-2.5 py-1 rounded-full border w-fit',
                    urg.text, urg.bg, urg.border,
                  )}>
                  ...
                  <div className="relative">
                    {isUpdating ? (
                      ...
                      <select
                        ...
                        className={cn(
                          'text-[12px] font-semibold px-2 py-1 rounded-lg border cursor-pointer outline-none transition-colors appearance-none pr-6',
                          sta.text, sta.bg, sta.border,
                        )}
