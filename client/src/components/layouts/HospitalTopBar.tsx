    ...
    <header className="h-14 bg-white border-b border-[#E8E4D8] flex items-center justify-between px-7 flex-shrink-0 sticky top-0 z-40">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="pl-8 pr-4 h-8 w-60 text-[13px] bg-cream border border-[#E8E4D8] rounded-full outline-none focus:border-brand-400 transition-colors"
        />
      </div>
      ...
      <div className="flex items-center gap-1.5">
        ...
        <div className="w-8 h-8 rounded-full bg-brand-600 flex items-center justify-center text-white text-[11px] font-semibold ml-1 cursor-pointer">
          DR
        </div>
      </div>
    </header>
...
function IconBtn({
  ...
  return (
    <button
      aria-label={label}
      className="relative w-8 h-8 rounded-lg border border-[#E8E4D8] bg-white flex items-center justify-center text-[#6B7A5A] hover:bg-cream transition-colors"
    >
      {children}
      {badge > 0 && (
