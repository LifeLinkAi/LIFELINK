...
const IcoChatBtn = () => <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>;
...
const NAV_ITEMS = [
  ...
  { label: "Availability",      href: "/donor/availability",     icon: <IcoCal   /> },
  { label: "Nearby Hospitals",  href: "/donor/nearby-hospitals", icon: <IcoHosp  /> },
  { label: "History",           href: "/donor/history",          icon: <IcoHist  /> },
  { label: "Live Chats",        href: "/donor/live-chats",       icon: <IcoChat  /> },
